  ...
  return (
    <>
      <div className="venue-wrap rev-s">
        <Image
          src="https://avatars.mds.yandex.net/get-altay/3766813/2a000001762c6753e3f300e6fe0631365de4/XXXL"
          alt="Amir Restaurant"
          fill
          sizes="100vw"
        ...
        <div className="venue-cap">
          <div className="venue-cap-n">Amir Restaurant</div>
      ...
      <div className="sec sec-framed rev bg-white" style={{'paddingTop':'clamp(44px,8vw,68px)','paddingBottom':'clamp(44px,8vw,68px)'}}>
        ...
        <h2 className="s-title-script">Amir Restaurant</h2>
        ...
        <div className="map-btns">
          <a href="https://maps.app.goo.gl/jVDKYnDhGKXVDAPk9" target="_blank" rel="noopener noreferrer" className="map-btn rev-l">
          ...
          <a href="https://yandex.uz/maps/-/CTvlrOYO" target="_blank" rel="noopener noreferrer" className="map-btn rev-r">
            <svg width="20" height="26" viewBox="0 0 36 46" fill="none"><path d="M18 2C10.3 2 4 8.3 4 16c0 11.5 14 28 14 28S32 27.5 32 16C32 8.3 25.7 2 18 2z" fill="#ecdecf" stroke="#c4a882" strokeWidth="1.4"/><circle cx="18" cy="16" r="5" stroke="#c4a882" strokeWidth="1.2" fill="none"/></svg>
